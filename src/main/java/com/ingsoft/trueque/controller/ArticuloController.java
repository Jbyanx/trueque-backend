...
public class ArticuloController {
    ...
    @GetMapping
    public ResponseEntity<Page<GetArticulo>> getAllArticulosDisponibles(Pageable pageable){
        return ResponseEntity.ok(articuloService.getAllArticulosDisponibles(pageable));
    }
    ...
    public ResponseEntity<Page<GetArticulo>> getAllArticulosDisponiblesByusuarioId(Pageable pageable, @PathVariable Long usuarioId){
