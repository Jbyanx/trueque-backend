...
alter table articulos
    add constraint fk_articulo_usuario foreign key (id_usuario) references usuarios;
...
alter table reportes
    add constraint fk_reporte_usuario foreign key (id_usuario) references usuarios;

alter table resenhas
    add constraint fk_resenha_autor foreign key (id_autor) references usuarios;

alter table resenhas
    add constraint fk_resenha_intercambio foreign key (id_intercambio) references intercambios;
